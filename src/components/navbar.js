...
function Navbar() {
  return (
    <div>
        ...
        <ul className="nav-ul">
            <li><a href="/">Home</a></li>
            <li><div><a href="">About Us</a><div className="dropdown-content"><a href="/about">Meet the Operators</a><a href="/meet-the-team">Meet the Team</a></div></div></li>
            <li><div><a href="">Training</a><div className="dropdown-content"><a href="/path-for-growth">Path for Growth</a><a href="https://www.pathway.cfahome.com/" target="_blank">Pathway</a></div></div></li>
